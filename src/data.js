...
export const workHistory = [
  ...
  {
    company: "Tajin International",
    position: "Digital Marketing Manager",
    dates: "03/2018 - 12/2019",
    description:
      "<bold>Managed all digital marketing efforts for Tajin seasoning in the US (including Puerto Rico) & Canada. Collaborated with design team to create engaging content for social media platforms and websites. Set reasonable KPI's to encourage and track growth.",
  },

  {
    ...
    description:
      "<bold>Managed digital campaigns for various business customers. Set expectations with clients for growth and predictable sales thru digital streams. Used Google and Facebook Analytics to create and track campaigns.",
  },
];
